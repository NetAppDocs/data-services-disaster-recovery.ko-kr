...
summary: VM 인프라를 보호하기 전에 NetApp Disaster Recovery 서비스는 보호할 VM을 호스팅하는 VMware vCenter 클러스터와 해당 vCenter의 위치를 ​​알아야 합니다.  첫 번째 단계는 소스 및 대상 데이터 센터를 나타내는 사이트를 만드는 것입니다.  사이트는 장애 도메인 또는 복구 도메인입니다. 
---
...
. NetApp Disaster Recovery 의 모든 페이지에서 *사이트* 옵션을 선택합니다.
+
