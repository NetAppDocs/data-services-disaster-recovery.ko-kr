...
[role="lead"]
NetApp Disaster Recovery가 정상적으로 작동할 수 있도록 필요한 ONTAP 권한을 구성하십시오.
...
재해 복구를 위해서는 다음과 같은 ONTAP 권한이 필요합니다.
...
ONTAP에서 권한을 추가하려면 필요한 권한을 가진 역할을 생성하고 사용자에게 할당합니다. 이 작업은 System Manager 또는 ONTAP CLI를 사용하여 ONTAP에서 완료할 수 있습니다.
