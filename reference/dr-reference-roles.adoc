...
summary: NetApp 재해 복구는 역할을 사용하여 각 사용자가 특정 기능과 작업에 대해 갖는 액세스를 관리합니다. 
---
= NetApp 재해 복구 역할 기반 기능 액세스
:hardbreaks:
:allow-uri-read: 
:icons: font
:imagesdir: ../media/use
...
[role="lead"]
NetApp 재해 복구는 역할을 사용하여 각 사용자가 특정 기능과 작업에 대해 갖는 액세스를 관리합니다.
...
이러한 역할은 NetApp 재해 복구에만 적용되며 NetApp 콘솔에서 사용되는 플랫폼 역할과 동일하지 않습니다.  모든 NetApp 콘솔 플랫폼 역할에 대한 자세한 내용은 다음을 참조하세요. https://docs.netapp.com/us-en/bluexp-setup-admin/reference-iam-predefined-roles.html["NetApp 콘솔 설정 및 관리 문서"^] .

다음 표는 각 NetApp 재해 복구 역할이 수행할 수 있는 작업을 나타냅니다.
