...
검토하세요link:https://docs.netapp.com/us-en/data-services-disaster-recovery/get-started/dr-prerequisites.html["전제 조건"] 그리고link:https://docs.netapp.com/us-en/data-services-disaster-recovery/release-notes/dr-limitations.adoc["제한 사항"] Google Cloud를 위해.
